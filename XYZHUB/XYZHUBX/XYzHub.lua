...
if PlaceID == 6329844902 then
    ...
    game.Players.LocalPlayer:Kick("This Script Only Support Last Pirate!")
end
-----------------------------------------
	...
	local PresetColor = Color3.fromRGB(67, 206, 255)
	...
	function create:Win(text)
		...
		NameReal.TextColor3 = Color3.fromRGB(0,250,225)
	...
	--Time.AnchorPoint = Vector2.new(0.5, 0.5)
		...
		TextButton_Toggle2.MouseButton1Click:Connect(function()
			...
			function items:Button(text,callback)
				...
				Button.TextColor3 = Color3.fromRGB(0, 250, 250)
...
function Not()
    ...
    Title = "XYz Hub"; -- the title (ofc)
    Text = "Select Weapon First"; -- what the text says (ofc)
...
function Fot()
    game.StarterGui:SetCore("SendNotification", {
    Title = "XYz Hub"; -- the title (ofc)
    Text = "Select Fruit First"; -- what the text says (ofc)
    Icon = "rbxassetid://57254792"; -- the image if u want. 
    Duration = 2; -- how long the notification should in secounds 
    })
end
function Sec()
    game.StarterGui:SetCore("SendNotification", {
    Title = "XYz Hub"; -- the title (ofc)
    Text = "Success Fully Copy Code!"; -- what the text says (ofc)
...
function Wea()
    game.StarterGui:SetCore("SendNotification", {
    Title = "XYz Hub"; -- the title (ofc)
    Text = "Success Select Weapon"; -- what the text says (ofc)
    Icon = ""; -- the image if u want. 
    Duration = 2; -- how long the notification should in secounds
    })
end
function Fse()
    game.StarterGui:SetCore("SendNotification", {
    Title = "XYz Hub"; -- the title (ofc)
    Text = "Success Select Fruit"; -- what the text says (ofc)
    Icon = ""; -- the image if u want. 
...
function Next()
    game.StarterGui:SetCore("SendNotification", {
    Title = "XYz Hub"; -- the title (ofc)
    Text = "Coming Soon!"; -- what the text says (ofc)
    Icon = ""; -- the image if u want. 
    Duration = 2; -- how long the notification should in secounds
    })
end
----------------------------------------- Gui Go
	local Window = create:Win("X Y Z - H U B    |   L A S T - P I R A T E ")
	local Tap1 = Window:Taps("Hop Menu")
	...
	page9:Label("Discord : XYz Hub ")

	function TPSever()
    game.StarterGui:SetCore("SendNotification", {
    Title = "XYz Hub"; -- the title (ofc)
    Text = "This Server Is Max Players Wait For Script Hop Server!"; -- what the text says (ofc)
    ...
    while wait(0.2) do
        if _G.Shisui then 
            if game.Players.LocalPlayer.PlayerStats.Experience.Value >= 10 then
                ...
                game:GetService("ReplicatedStorage").BuyMysterious:InvokeServer("Shushi",false)
                wait(5)
                game.Players.LocalPlayer:Kick("YOU GOD SWORD")
